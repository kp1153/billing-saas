  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex justify-around py-2 z-10">
        <Link href="/dashboard" className="flex flex-col items-center text-xs text-gray-500 hover:text-blue-600 py-1">
        ...
        <Link href="/dashboard/bill" className="flex flex-col items-center text-xs text-gray-500 hover:text-blue-600 py-1">
        ...
        <Link href="/dashboard/saman" className="flex flex-col items-center text-xs text-gray-500 hover:text-blue-600 py-1">
        ...
        <Link href="/dashboard/grahak" className="flex flex-col items-center text-xs text-gray-500 hover:text-blue-600 py-1">
          <svg className="w-5 h-5 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
          ग्राहक
        </Link>
        <Link href="/dashboard/report" className="flex flex-col items-center text-xs text-gray-500 hover:text-blue-600 py-1">
